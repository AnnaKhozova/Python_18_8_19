...
N = int (input("Здравствуйте, введите необходимое количество билетов  "))
S = 0
for i in range(1, N + 1):
    Age = int (input("Введите возраст участника "))
    if Age < 18:
        print('Этот участник проходит бесплатно')
    elif 18 <= Age <= 25:
        print('Стоимость этого билета 990р')
        S = S + 990
    else:
        print('Стоимость этого билета 1390р')
        S = S + 1390
if N > 3:
    S = S - S * 0.1
print('К оплате ', S, 'р')
